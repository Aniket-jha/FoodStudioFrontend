...
const CookiesPolicy = () => {
  return (
   ...
   <div style={{padding:"15px 20px"}} >
       <h1>Cookie Policy for Food Studio</h1>

<p>This is the Cookie Policy for Food Studio, accessible from https://www.foodstudio.co.in</p>
...
<ul>
<li>Email: info@foodstudio.co.in</li>
